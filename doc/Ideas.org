...
Chunkserver should store blocks in some integer multiple of the FS blocks minus a little for overhead.

What is a "first pass" -- control cli can connect to clustered servers and report back statistics on the bunch of them
...
fuse client -
control cli -   metaserver cluster   -  blockservers
